...
const DetailsLP= () => {
    ...
    console.log('최종 포멧',prettireFromet_date, '원시 값',CreatedAT, dateObj)
    console.log(data)
    return (
        <>
            <main>
            ...
            <span className="username">{data?.data.data.author.name}</span>
          </div>
        ...
        <div className="title-row">
          <h2 className="song-title">{data?.data.data.title}</h2>
